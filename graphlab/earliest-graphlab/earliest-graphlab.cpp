...
class earliest : public graphlab::ivertex_program<graph_type, graphlab::empty,
...
public:
               ...
               const graphlab::empty& empty)
    {
        ...
        else
        {
            ...
            {
                if (vertex.data().originalID == SOURCE_VERTEX)
...
int main(int argc, char** argv)
{
    ...
    for (int i = 0; i < QUERY_SIZE; ++ i)
    {
		...
		graphlab::omni_engine<earliest> engine(dc, graph, exec_type);
		engine.signal_all();
		engine.start();
